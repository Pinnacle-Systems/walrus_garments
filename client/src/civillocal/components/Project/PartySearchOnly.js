...
const PartySearchOnly = ({ setPartyId, partyId, name = null, readOnly, id, isVendor = null }) => {
    ...
    return (
        <div id='pageSearch' className='relative flex flex-col text-black z-10 w-full' ref={inputRef}>
            <div className='grid grid-cols-1 md:grid-cols-3 items-center md:my-0.5 md:px-1 data gap-1'>
                ...
                {
                    id ?
                        <div className={`text-left  p-1 w-52 h-6 focus:outline-none border-gray-500 border rounded`}>
...
export default PartySearchOnly
