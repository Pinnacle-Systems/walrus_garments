...
const PrintFormat = ({ data, isDrawingWeight, isIgst, stateList, quoteVersion }) => {
                ...
                <View fixed style={tw("w-full")}>
                    <View style={tw("flex flex-row justify-between p-1")}>
                        ...
                        <View style={tw("w-1/2 pl-8")}>
                            ...
                            <Text style={{ fontSize: 11 }}>Old Bustand, Tiruppur, TN (33), IN</Text>
                        </View>
                ...
                <View style={tw("w-full text-sm border-x text-sky-800 font-bold  border-b border-gray-500 text-center flex flex-row h-[20px]")}>
...

                    {
                        isIgst ?
                            ...
                            :
                            <>
                                <View style={tw("flex flex-row border-r border-gray-500 justify-end items-center w-[8%]")}>
                                    <Text>
