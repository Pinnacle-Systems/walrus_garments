...
const PrintFormat = ({ data, isDrawingWeight, isIgst, stateList }) => {
                ...
                <View fixed style={tw("w-full")}>
                    <View style={tw("flex flex-row justify-between items-center p-1")}>
                        ...
                        <View style={tw("w-1/2  rounded-md text-center p-2")}>
                            <Text style={{ fontSize: 16 }}>Tax Invoice</Text>
                        </View>
                        <View style={tw("w-1/4")}>
                ...
                <View fixed style={tw("w-full")}>
                    <View style={tw("flex flex-row justify-between p-1")}>
                        <View style={tw("w-2/4 -mt-5 gap-y-0.5")}>
                            ...
                            <Text style={{ fontSize: 10, marginBottom: 3 }}>+919597639777</Text>
                            <Text style={{ fontSize: 10, marginBottom: 3 }}>1universalassociates@gmail.com</Text>
                ...
                <View fixed style={tw("w-full")}>
                    <View style={tw("flex flex-row justify-between p-1")}>
                        <View style={tw("w-2/4")}>
                            ...
                            <Text style={{ fontSize: 10, marginBottom: 3 }}>Old Bustand , Tiruppur, TN (33), IN </Text>
                        </View>
