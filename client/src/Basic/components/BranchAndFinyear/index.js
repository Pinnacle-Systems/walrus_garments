...
//     const onSubmit = () => {
//         if (!(currentBranch && currentFinYear)) {
//             toast.error("Select Branch and Fin. Year", { position: 'top-center' });
//             return
//         }
//         secureLocalStorage.setItem(sessionStorage.getItem("sessionId") + "currentBranchId", currentBranch);
//         secureLocalStorage.setItem(sessionStorage.getItem("sessionId") + "currentFinYear", currentFinYear);
...
//     return (
//         <div className="flex flex-col items-center justify-center bg-white z-50 p-6">
//             <form className="w-full max-w-md bg-white rounded-lg shadow-md p-6 space-y-4">

//                 {/* Branch Selection */}
//                 <div>
//                     <label className="block text-gray-800 font-semibold mb-1" htmlFor="branch">
//                         Branch
//                     </label>
//                     <select
//                         className="w-full p-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
//                         id="branch"
//                         name="branch"
//                         value={currentBranch}
//                         onChange={(e) => setCurrentBranch(e.target.value)}
...
//                 <div>
//                     <label className="block text-gray-800 font-semibold mb-1" htmlFor="finyear">
//                         Financial Year
//                     </label>
//                     <select
//                         className="w-full p-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400"
...
//                     <button
//                         onClick={() => setIsGlobalOpen(false)}
//                         className="w-24 py-2 rounded-lg bg-gray-500 text-white hover:bg-gray-600 transition duration-200"
//                         type="button"
//                     >
//                         Back
//                     </button>
//                     <button
//                         onClick={onSubmit}
//                         className="w-24 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 transition duration-200"
//                         type="button"
//                     >
//                         Submit
//                     </button>
