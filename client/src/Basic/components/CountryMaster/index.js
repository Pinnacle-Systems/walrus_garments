...
//   console.log(singleData, "singledataaa")
...
//       }
//       try {
//         let deleteData = await removeData(id).unwrap();

//         if (deleteData?.statusCode == 1) {
//           let message = deleteData?.message
//           toast.error(message)
//           return
//         }
//         setId("");
...
import { useAddCountryMutation, useDeleteCountryMutation, useGetCountriesQuery, useGetCountryByIdQuery, useUpdateCountryMutation } from '../../../redux/services/CountryMasterService';
