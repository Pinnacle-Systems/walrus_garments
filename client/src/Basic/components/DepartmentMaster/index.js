...
import { ToggleButton, ReusableTable, TextInputNew1 } from "../../../Inputs";
...
export default function Form({ onSuccess, onClose, editId, deleteId, deleteLabel } = {}) {
  ...
  const saveData = (nextProcess) => {
    ...
    const finalData = { ...data, name: upperName, code: upperCode };
    ...
    if (foundItem) {
      Swal.fire({ text: "The Department Name already exists.", icon: "warning" });
      nameRef.current?.focus();
      return false;
    }
    ...
    return (
      <div className="h-full flex flex-col bg-gray-200">
        <div className="border-b py-2 px-4 mx-3 flex mt-4 justify-between items-center sticky top-0 z-10 bg-white">
          <h2 className="text-lg px-2 py-0.5 font-semibold text-gray-800">Delete Department</h2>
        </div>
            ...
            <>
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-gray-600 text-center">
                  ...
                  Remove them first before deleting this department.
                </p>
              </div>
