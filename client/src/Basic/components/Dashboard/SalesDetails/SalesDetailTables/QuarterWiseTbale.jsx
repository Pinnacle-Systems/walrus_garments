...
import { useGetMonthlySalesTableQuery, useGetQuarterSalesTableQuery, useGetYearlySalesTableQuery } from
...
const QuarterWiseTable = ({
    year, company, closeTable, finYrData, type, SalesType, setSalesType, setType, quarter
}) => {
            ...
            <div className="bg-white w-[1350px] h-[630px] p-4 rounded-xl relative">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="font-bold uppercase">
                        Quarterly Wise Sales - <span className="text-blue-600 ">{localCompany || ""}</span>
                    </h2>
