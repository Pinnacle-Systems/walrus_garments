...
import { useGetMonthlySalesTableQuery, useGetWeeklySalesTableQuery, useGetYearlySalesTableQuery } from
...
const WeekWiseTable = ({
    year, company, closeTable, finYrData, type, SalesType, setSalesType, setType, week
}) => {

    console.log(year, company, week, "receivedparams")
            ...
            <div className="bg-white w-[1350px] h-[630px] p-4 rounded-xl relative">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="font-bold uppercase">
                        Weekly Wise Sales - <span className="text-blue-600 ">{localCompany || ""}</span>
                    </h2>
