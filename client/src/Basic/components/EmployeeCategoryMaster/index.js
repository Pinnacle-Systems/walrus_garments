...
export default function Form({ onSuccess, onClose, editId, deleteId, deleteLabel } = {}) {
    ...
    const columns = [
        ...
        { header: "Employee Category Name", accessor: (item) => item?.name, className: "font-medium text-gray-900 text-left pl-2 uppercase w-96" , enableSearch : true  },
    ...
    return (
        <MasterPageLayout
            ...
            addButtonLabel="+ Add New Employee Category"
