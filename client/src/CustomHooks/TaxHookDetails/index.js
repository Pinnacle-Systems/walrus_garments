...
//     function getTotalQuantity(taxTerm, valueOrAmount) {
//   let calculateItems = structuredClone(poItems)
//   let rawFormula = getFormulaByName(taxTerm)[valueOrAmount]
//   let formula = getRegex(rawFormula) // must return valid JS expression

//   const total = calculateItems.reduce((acc, item) => {
//     let price = parseFloat(item.price) || 0
//     let qty = parseFloat(item.qty) || 0
//     let discountValue = parseFloat(item.discountValue) || 0
//     let taxPercent = parseFloat(item.taxPercent) || 0

//     // Example: formula must look like: "price * qty - discountValue"
//     const fn = new Function(
//       "price", "qty", "discountValue", "taxPercent",
//       `return ${formula};`
//     )

//     return acc + fn(price, qty, discountValue, taxPercent)
//   }, 0)
