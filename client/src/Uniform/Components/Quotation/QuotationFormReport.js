                                ...
                                <Tooltip title={dataObj?.Saleorder?.length > 0 ? "Cannot Edit. Child Record Exists" : "Edit"} arrow>
                                  <span>
                                    <button
                                      ...
                                      onClick={(e) => { e.stopPropagation(); if (!(dataObj?.Saleorder?.length > 0)) hasPermission(() => onEdit(dataObj.id), "edit"); }}
                                    >
                                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <Tooltip title={dataObj?.Saleorder?.length > 0 ? "Cannot Delete. Child Record Exists" : "Delete"} arrow>
                                  <span>
                                    <button
                                      ...
                                      onClick={(e) => { e.stopPropagation(); if (!(dataObj?.Saleorder?.length > 0)) hasPermission(() => onDelete(dataObj.id, dataObj?._count), "delete", dataObj?._count); }}
                                    >
                                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
