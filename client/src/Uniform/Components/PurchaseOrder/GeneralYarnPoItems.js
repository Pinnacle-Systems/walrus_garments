                                ...
                                >
                                    ...
                                    <td className="py-0.5 border border-gray-300 text-[11px] td-outline-focus">
                                        <select
                                            ...
                                            tabIndex={"0"} 
                                            disabled={readOnly || transType == "Order Purchase" || !transType || row.alreadyInwardedQty > 0 || row?.cancelQty > 0} className='text-left w-full rounded py-1 focus'
                                            value={row.yarnId}
                                    ...
                                    <td className="w-40 py-0.5 border border-gray-300 text-[11px] text-right td-outline-focus">
                                        <input
                                            type="number"
                                            onFocus={(e) => e.target.select()}
                                            className="text-right rounded py-1 w-16 px-1 "
