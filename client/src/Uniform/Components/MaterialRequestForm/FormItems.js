...
const FormItems = ({ orderSizeDetails, orderYarnDetails, setRaiseIndentItems, raiseIndentItems, readOnly, id, isRaiseRendent, setRaiseIndenet, setSubGridForm, subGridForm,
