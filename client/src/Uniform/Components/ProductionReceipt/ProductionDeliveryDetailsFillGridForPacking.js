...
const ProductionDeliveryDetailsFillGridForPacking = ({ boxQty, setBoxQty, markRead, setMarkRead, boxCount, packingCategory, packingType, orderDetails, id, productionDeliveryDetailsFillData, setProductionDeliveryDetailsFillData, isPacking,
        ...
        setProductionReceiptDetails(prev => {
            ...
            item?.sizeArray.forEach(element => {
                ...
                newInwardDetails.push({
                    ...
                    maleInwardQty: element?.orderQtyForMale ? element?.orderQtyForMale : 0,
                    femaleInwardQty: element?.orderQtyForFemale ? element?.orderQtyForFemale : 0,
    ...
    return (
        <>{console.log(productionReceiptDetails, "productionrec")}
            <div className={`w-full h-[600px] overflow-auto`}>
                <div className='grid grid-cols-8 mb-2'>
                    <div className='col-span-3'>
                        <h1 className='text-center mx-auto font-bold'>Packing Set- Set/Classwise</h1>
                    </div>
                ...
                <table className=" text-xs table-fixed w-full">
                    ...
                    <tbody>
                        {(productionDeliveryDetailsFillData ? productionDeliveryDetailsFillData : []).map((item, index) =>
                            <ClassHeading markRead={markRead} findReadOnly={findReadOnly} findReadOnlyAll={findReadOnlyAll} productionDeliveryDetailsFillData={productionDeliveryDetailsFillData}
...
export default ProductionDeliveryDetailsFillGridForPacking