...
const ProductionReceiptDetailItemForIndividual = ({ item, index, groupData, setGroupData, isIroning, isStitching, id, productionReceiptDetails, setCurrentSelectedIndex, setProductionReceiptDetails, productionDeliveryDetailsFillData, readOnly, isPacking }) => {
            ...
            <td className='table-data'>
                <input
                    ...
                    onChange={(e) => {
                        ...
                        handleInputChange(e.target.value, index, "box", item?.classId)
                    }}
...
export default ProductionReceiptDetailItemForIndividual