...
const CuttingDeliveryFormReport = ({
  ...
  const { data: allData, isLoading, isFetching } = useGetCuttingDeliveryQuery({ params: { branchId, ...searchFields, finYearId, pagination: true, dataPerPage, pageNumber: currentPageNumber } });
