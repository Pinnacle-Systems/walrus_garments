                                        ...
                                        <table className="border-collapse w-full">
                                            <thead className="bg-gray-200 text-gray-800">
                                                <tr>
                                                    ...
                                                    <th className="px-4 py-1.5 border border-gray-300 text-xs  w-96">Accessory</th>


                                                    <th className="px-4 py-1.5 border border-gray-300 text-xs text-gray-800  w-24">Color</th>
                                                    <th className="px-4 py-1.5 border border-gray-300 text-center text-xs w-24">Size</th>
