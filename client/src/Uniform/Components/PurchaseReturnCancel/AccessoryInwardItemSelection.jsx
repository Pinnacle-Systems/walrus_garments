...
import { useGetDirectItemsQuery } from '../../../redux/uniformService/DirectInwardOrReturnServices';


const AccessoryInwardItemSelection = ({ poType, supplierId, isItemAdded, handleChange, getSelectAll, handleSelectAllChange, storeId }) => {
...
export default AccessoryInwardItemSelection