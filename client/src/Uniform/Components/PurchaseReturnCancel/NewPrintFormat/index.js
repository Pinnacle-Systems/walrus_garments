...
//       <>
//         <div className="h-[950px] w-full flex flex-col justify-between border-2 m-0 border-black" id='poPrint' >
...
const Form = ({
  ...
  const {
    isLoading: isTaxHookDetailsLoading,
    ...taxDetails
  } = useTaxDetailsHook({
    poItems,
    ...
    >
      <div>
        ...
        <div className="flex">
          ...
          <div className="text-start p-2 w-full">
            <div className="grid text-xs">
              <h1 className="w-[350px]">{branchData.address}</h1>
              <h1>{branchData.mobile}</h1>
              <h1>PANNO: {branchData.panNo}</h1>
              <h1>GSTNO: {branchData.gstNo}</h1>
            </div>
          </div>
        </div>
      ...
      <div className="w-full">
        <div className="w-full border border-gray-600 flex items-center">
          ...
          {/* <span className="text-xs">
            Rs.{numberToText?.convertToText(taxDetails?.netAmount, {
              language: "en-in",
              separator: "",
            })}{" "}
            Only
        ...
        <div className="w-full">
          <h1 className="text-sm w-full font-bold">Terms and Conditions :</h1>
          <h1 className="text-[10px] w-full border-b border-gray-600">
            {termsAndCondition?.data
