...
const PurchaseOrderFormReport = ({
  ...
  const { data: allData, isLoading, isFetching } = useGetDirectCancelOrReturnQuery({ params: { branchId, finYearId, inwardOrReturn: "DirectInward", ...searchFields, pagination: true, dataPerPage, pageNumber: currentPageNumber } });
