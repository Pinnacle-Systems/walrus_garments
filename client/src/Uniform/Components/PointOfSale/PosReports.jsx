                ...
                <table className="text-left w-full border-separate border-spacing-0">
                    <thead className="bg-white sticky top-0 z-20 shadow-sm border-b border-slate-200">
                        <tr className="bg-slate-50/50">
                            <th className="px-2 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center w-12 border-b border-r border-slate-200">S No</th>
                            <th className="px-3 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center w-48 border-b border-r border-slate-200">Pos No</th>
                            <th className="px-3 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center w-48 border-b border-r border-slate-200">Pos Date</th>
                            <th className="px-3 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center border-b border-r border-slate-200">Customer</th>
                            <th className="px-3 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center w-32 border-b border-r border-slate-200">Method</th>
                            <th className="px-3 py-2 font-bold text-[10px] text-slate-500 uppercase tracking-widest text-center w-20 border-b border-slate-200">Action</th>
                        </tr>
