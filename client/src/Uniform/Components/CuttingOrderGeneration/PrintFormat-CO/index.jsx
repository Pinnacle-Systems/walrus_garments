...
export default function PrintFormat({ data, singleData, date, docId, cuttingOrderDetails, selectedSizeList,
  selectedStyleList, tempOrderDetails }) {
  ...
  return (
    <Document>
      <CuttingOrder singleData={singleData} styles={styles} data={data} date={date} docId={docId}
        getTotals={getTotals} cuttingOrderDetails={cuttingOrderDetails} selectedSizeList={selectedSizeList}
        selectedStyleList={selectedStyleList} tempOrderDetails={tempOrderDetails}
      />
    </Document>
  );
}
