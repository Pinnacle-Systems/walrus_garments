      ...
      <table className=" text-xs border  border-gray-500 table-auto w-full">
        <thead className=' border border-gray-500 top-0 bg-green-200'>
          <tr className='h-8'>
            ...
            <th className='tx-table-cell p-1'>
              Accessory Items
            </th>
            <th className='tx-table-cell p-1'>
              Accessory Group
        ...
        <tbody>
          {poItems.map((value, index) => (
            <tr className='border  border-gray-500 w-full' key={index}>
              ...
              <td className='tx-table-cell  px-1 h-8 '>
                {value.Accessory?.aliasName}
              </td>
              <td className=' px-1  tx-table-cell '>
              ...
              <td className='tx-table-cell text-center px-1 text-right '>{parseFloat(value.qty).toFixed(3)}</td>
              <td className='tx-table-cell text-center px-1  text-right'>{parseFloat(value.price).toFixed(2)} </td>
