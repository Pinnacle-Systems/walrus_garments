...
const RequirementPlanningFormReport = ({
    onClick,
    onView,
    itemsPerPage = 10,
    onEdit,
                        ...
                        <table className="">
                            <thead className="bg-gray-200 text-gray-800 ">
                                ...
                                <tr className="">
                                    ...
                                    <th className=" px-1 font-medium text-[13px] border  text-gray-900  text-center ">
                                        <input
                                            type="text"
                                    ...
                                    <th className="w  px-1 font-medium text-[13px]  text-gray-900  text-center ">
                                        <input
                                            type="text"
                                            className="text-black h-5   w-full   px-1 focus:outline-none border  border-gray-400 rounded-md"
                                            placeholder="Search"
                                ...
                                <tbody className="border-2">
                                    {(allData?.data ? allData?.data : []).map((dataObj, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="py-1.5 text-left"> {`${dataObj?.OrderDetails?.style?.name} / ${dataObj?.allColors}` } </td>
...
export default RequirementPlanningFormReport;
