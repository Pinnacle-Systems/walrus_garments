            ...
            <thead className='border text-sm'>
                ...
                {!readOnly &&
                    <th className='table-data text-center'>
                        <button className='text-green-500' onClick={() => { addNewLotNo(index, inwardLotDetails[0] ? inwardLotDetails[0].weightPerBag : "0.000") }} >{PLUS}</button>
                    </th>
                }
            </thead>
            <tbody>
                        ...
                        <td className='text-center table-data'>
                            <input
                                ...
                                onChange={(event) => {
                                    ...
                                    let totalBagsExcludeCurrent = sumArray(inwardLotDetails.filter((_, index) => index !== lotIndex), "noOfBags")
            ...
            <tbody>
                ...
                {isDirect
                    ...
                    <tr className='table-row'>
                        ...
                        {!readOnly &&
                            <>
                                <td className='w-full'><button className='w-full bg-blue-500 text-white' onClick={() => onClose(balanceQty, (sumArray(inwardLotDetails, "qty")).toFixed(3))}>Done</button></td>
                            </>
                        }
                    </tr>
                }
