...
const AccessoryPoItemSelection = ({ poType, supplierId, isItemAdded, handleChange, getSelectAll, handleSelectAllChange, handleCancel, poInwardOrDirectInward, handleDone, id, readOnly, }) => {
    ...
    const searchFields = { searchDocId, searchPoDate, searchSupplierAliasName: supplier, searchPoType, searchDueDate }


    useEffect(() => {
        setCurrentPageNumber(1);
    }, [
        searchDocId, searchPoDate, supplier, searchPoType, searchDueDate
    ]);
