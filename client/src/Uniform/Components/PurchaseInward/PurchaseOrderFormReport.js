...
const PurchaseOrderFormReport = ({
  ...
  const { data: allData, isLoading, isFetching } = useGetDirectInwardOrReturnQuery({ params: { branchId, finYearId, inwardOrReturn: "DirectInward", ...searchFields, pagination: true, dataPerPage, pageNumber: currentPageNumber } });
  let isLoadingIndicator = isLoading || isFetching
  useEffect(() => {
