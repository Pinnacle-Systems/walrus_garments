...
const FabricPoItems = ({ id, transType, poItems, setPoItems, readOnly, params, isSupplierOutside, taxTypeId, greyFilter }) => {
        ...
        setPoItems(prev => {
            let newArray = Array.from({ length: 12 - prev.length }, i => {
                return {
                    ...
                    inwardLotDetails: [{ lotNo: "", noOfRolls: "0", qty: "0.000" }]
                };
            })
    ...
    const addRow = () => {
        const newRow = { fabricId: "", colorId: "", uomId: "", taxPercent: "0.000", gaugeId: "", designId: "", gsmId: "", loopLengthId: "", kDiaId: "", fDiaId: "", qty: "", price: "", noOfRolls: "", discountType: "Percentage", discountValue: "0.00", inwardinwardLotDetails: [{ lotNo: "", noOfRolls: "0", qty: "0.000" }] };
    ...
    function addNewLotNo(index, weightPerBag) {
        setPoItems(poItems => {
            ...
            if (newBlend[index]["inwardLotDetails"]) {
                ...
                newBlend[index]["inwardLotDetails"] = [{ lotNo: "", qty: "0.000", noOfRolls: 0, weightPerBag }]
            }
            return newBlend
        })
    }
    ...
    let lotNoArr = selectedRow?.inwardLotDetails ? selectedRow.inwardLotDetails.map(item => item.lotNo) : []
