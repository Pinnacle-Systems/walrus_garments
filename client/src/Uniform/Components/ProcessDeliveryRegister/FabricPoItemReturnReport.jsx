      ...
      <table className='table-auto w-full text-xs border border-gray-500 '>
        <thead className=' border-b border-gray-500'>
          <tr className='bg-blue-200 border border-gray-500 sticky top-10 '>
            ...
            <th className="tx-table-cell  w-10">Return Rolls</th>
            <th className="tx-table-cell  w-10">Return Qty</th>
          </tr>
        </thead>
        <tbody>
          {inwardItems.map((item, index) =>
              ...
              <td className='text-right  tx-table-cell'>{item.noOfRolls}</td>
           ...
           <tr className='tx-table-row'>
            ...
            <td>Totals</td>
            <td className='text-right  tx-table-cell'>{sumArray(inwardItems.filter(item => item.noOfRolls), "noOfRolls")}</td>
