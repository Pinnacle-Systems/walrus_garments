...
import { useAddAccessoryPurchaseCancelMutation, useDeleteAccessoryPurchaseCancelMutation, useGetAccessoryPurchaseCancelByIdQuery, useGetAccessoryPurchaseCancelQuery, useUpdateAccessoryPurchaseCancelMutation } from "../../../redux/uniformService/AccessoryPurchaseCancelServices";
...
const PurchaseCancelForm = ({ onClose, id, setId }) => {
  ...
  } = useGetAccessoryPurchaseCancelByIdQuery(id, { skip: !id });
  ...
  const [addData] = useAddAccessoryPurchaseCancelMutation();
  const [updateData] = useUpdateAccessoryPurchaseCancelMutation();
