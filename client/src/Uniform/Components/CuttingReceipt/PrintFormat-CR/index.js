...
import CuttingReceipt from './CuttingReceipt';
...
export default function PrintFormat({  singleData, docId }) {
  ...
  function getTotals(field) {
    const total = singleData?.CuttingReceiptInwardDetails
  ...
  return (
   ...
   <CuttingReceipt  singleData ={singleData} docId ={docId}  styles={styles}  substract={substract} getTotals={getTotals} findAmount={findAmount} />
