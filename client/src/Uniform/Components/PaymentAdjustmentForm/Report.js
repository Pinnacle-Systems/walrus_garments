...
import { useGetPaymentAdjustmentQuery } from "../../../redux/services/PaymentAdjustmentService";
...
const ExpenseEntryReport = ({
    ...
    const { data: allData, isFetching, isLoading } = useGetPaymentAdjustmentQuery({
        params: {
            branchId,
            ...searchFields,
            pagination: true,
