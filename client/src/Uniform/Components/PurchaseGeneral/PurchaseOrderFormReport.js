...
import { useGetGeneralPurchaseQuery } from '../../../redux/uniformService/GeneralPurchaseServices';
...
const PurchaseOrderFormReport = ({
  ...
  const { data: allData, isLoading, isFetching } = useGetGeneralPurchaseQuery({ params: { branchId, ...searchFields, pagination: true, dataPerPage, pageNumber: currentPageNumber, finYearId } });
