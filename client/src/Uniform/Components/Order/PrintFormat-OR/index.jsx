...
export default function PrintFormat ({singleData,docId,orderDetails,tempOrderDetails}){



let temp={tempOrderDetails}
console.log(temp,"tempOrderDetails OR")
    ...
    return (
        <>
       <Document>
            <Order singleData={singleData} styles={styles} docId={docId}  orderDetails={orderDetails}  tempOrderDetails={tempOrderDetails}/>
       </Document>
        </>
    )
