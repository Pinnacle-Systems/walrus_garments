                                            ...
                                            <fieldset className='frame rounded-tr-lg rounded-bl-lg w-full border border-gray-200 p-1 h-[25vh]'>
                                                ...
                                                <div className='flex flex-col justify-center items-start flex-1 w-full'>
                                                    <div className="grid grid-cols-5 gap-x-2 w-full">
                                                        ...
                                                        <DateInput name="Order Date" value={date} type={"date"} required={true} readOnly={true} disabled inputClass={"w-60"} />
                                                                        ...
                                                                        <table className="border border-gray-500 table-auto w-full">
                                                                            <thead className="border border-gray-500">
                                                                                <tr className=" bg-gray-400">
                                                                                    <th className=" border border-gray-500 text-sm px-2 py-0.5 w-8 text-center p-0.5">S.No</th>
                                                                                    <th className="px-0.5 py-0.5  border border-gray-500 text-sm">Style</th>
                                                                                    <th className="px-0.5 py-0.5  border border-gray-500 text-sm">Image</th>
                                                                                    <th className="px-0.5 py-0.5  border border-gray-500 text-sm">Needle</th>
                                                                                    ...
                                                                                    <th className="px-0.5 py-0.5  border border-gray-500 text-sm">Socks.Material</th>
                                                                            ...
                                                                            <tbody className="text-blue-gray-900 ">{console.log("orderDetails", orderDetails)}
                                                                                {(orderDetails ? orderDetails : []).map((item, index) =>
                                                                                    <tr className="border-b border-blue-gray-200 cursor-pointer " >
                                                                                        ...
                                                                                        <td className="py-0.5 px-3 border border-gray-300 w-32">
                                                                                            <div className='flex gap-2'>
                                                                                                ...
                                                                                                {item.filePath &&
                                                                                                    <>
                                                                                                        <span className="text-xs">{item.filePath ? item?.filePath?.name : item?.filePath}</span>
                                                                                ...
                                                                                <tr className='w-full h-7  '>
                                                                                    <td className=" text-center w-10 font-bold" colSpan={13}>Total</td>
