...
export default function FromOrderDetails({ fromOrderId, setOrderItems, orderItems, onClose, tempStockItems, stockItems, setStockItems, yarnList, colorList, accessoryList, uomList, sizeList
