...
const FormItems = ({ setOrderItems, orderItems, readOnly, colorList, transferType, singleData, id, accessoryList, sizeList,
    uomList, setRequirementId, stockItems, setStockItems, setTempOrderItems, tempOrderItems, tempStockItems, setTempStockItems,
                                        ...
                                        <tbody>
                                            {stockItems?.map((stock, index) => (
                                                ...
                                                >
                                                    ...
                                                    <td className=" border border-gray-300 text-[11px] py-1.5 px-2">
                                                        {findFromList(stock?.accessoryId, accessoryList, "aliasName")}
                                                    </td>
                                                    <td className=" border border-gray-300 text-[11px] py-1.5 px-2">
                                                    ...
                                                    <td className=" border border-gray-300 text-[11px] py-1.5 px-2">
                                                        {findFromList(stock?.uomId, uomList, "name")}
                                                    </td>
