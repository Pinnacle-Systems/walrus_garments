...
const FormItems = ({ orderSizeDetails, orderYarnDetails,  setRaiseIndentItems, raiseIndentItems, setOrderYarnDetails, id  , isRaiseRendent  , setRaiseIndenet}) => {
    ...
    const getQtyYarnSize = (sizeId, yarnId, colorId) => {
        ...
        const item = raiseIndentItems?.find(
    ...
    const getRequireWeight = (yarnId) => {
        return raiseIndentItems?.reduce((total, item) => {
                ...
                orderSizeDetails?.forEach(size => {
                    orderYarnDetails?.forEach(yarn => {
                        combined?.push({
                            ...
                            colorId: yarn.colorId,
                            qty: Number(((parseFloat(size.weight) * yarn?.percentage) / 100).toFixed(2)),
                            weight: size.weight,
                            uomId: size.uomId,
        ...
        console.log(raiseIndentItems,"requirementForm")
                    ...
                    <div className="w-[30%] flex justify-end items-center mt-4 mb-5">
                        ...
                        <table className="w-full border-collapse table-fixed">
                            ...
                            <tbody>
                                ...
                                {raiseIndentItems?.map((yarn, index) => (
                                    <tr>
                    ...
                    <div >
                        <label className="flex items-center space-x-2">
                            <input
                                ...
                                onClick={()  =>  setRaiseIndenet(true)}
                                value={isRaiseRendent}
                            />
