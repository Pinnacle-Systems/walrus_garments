...
const AccessoryPurchaseOrderReturnPrintFormat = ({
  poNumber,
  poDate,
  deliveryToId,
  dueDate,
    ...
    <Document>
      <Page size="A4" style={styles.borderBox}>
        ...
        <View style={styles.page}>
          ...
          <View >
            <Text style={styles.greenTitle}>ACCESSORY  PURCHASE RETURN </Text>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.th, { flex: 2 }]}>Gross</Text>
          </View>
          ...
          <View style={{ marginTop: 6, borderLeft: "1 solid #9ca3af", borderTop: "1 solid #9ca3af", borderRight: "1 solid #9ca3af", borderBottom: "1 solid #9ca3af" }}>
            ...
            <View style={{ padding: 5 }}>
              <Text style={{ fontSize: 8, fontWeight: "bold"  , height: 40}}>
...
export default AccessoryPurchaseOrderReturnPrintFormat;
