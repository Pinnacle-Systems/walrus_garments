...
export default function Form() {
    ...
    const { data: allData, isLoading, isFetching } = useGetStyleTypeMasterQuery({ params, searchParams: searchValue });
    const {
        data: singleData,
        isFetching: isSingleFetching,
        isLoading: isSingleLoading,
    } = useGetStyleTypeMasterByIdQuery(id, { skip: !id });


    const [addData] = useAddStyleTypeMasterMutation();
    const [updateData] = useUpdateStyleTypeMasterMutation();
    const [removeData] = useDeleteStyleTypeMasterMutation();
                        ...
                        <div className='col-span-3 grid md:grid-cols-2 border overflow-auto'>
                            <div className='mr-1 md:ml-2'>
                                <fieldset className='frame my-1'>
                                    <legend className='sub-heading'>Style Type Info</legend>
                                    <div className='grid grid-cols-1 my-2'>
                                        <TextInput name="Style Type" type="text" value={name} setValue={setName} required={true} readOnly={readOnly} disabled={(childRecord.current > 0)} />
