...
const AccessoryPoItems = ({ id, poItems, setPoItems, readOnly, params }) => {
    ...
    useEffect(() => {
        ...
        setPoItems(prev => {
            let newArray = Array.from({ length: 12 - prev.length }, i => {
                return { accessoryId: "", qty: "", colorId: "", taxPercent: "0.000", sizeId: "", uomId: "", price: "", discountType: "Percentage", discountValue: 0 }
            })
    ...
    const addRow = () => {
        const newRow = { accessoryId: "", qty: "", colorId: "", taxPercent: "0.000", sizeId: "", uomId: "", price: "", discountType: "Percentage", discountValue: 0 };
