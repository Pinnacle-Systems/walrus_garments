            ...
            <table className="w-auto border border-gray-300">
              <thead className="bg-gray-200 text-gray-800">
                <tr>
                  ...
                  <th className="w-24 px-4 py-2 text-center font-medium text-[13px]">No Of Pairs</th>
                  {/* <th className="w-28 px-4 py-2 text-center font-medium text-[13px]">Yarn Count</th> */}

                  <th className="w-24 px-4 py-2 text-center font-medium text-[13px]">Pair Weight</th>
                  {/* <th className="w-24 px-4 py-2 text-center font-medium text-[13px]">Needle Type</th> */}
