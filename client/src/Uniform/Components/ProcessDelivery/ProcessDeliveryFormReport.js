...
import { useGetProcessDeliveryQuery } from '../../../redux/uniformService/ProcessDeliveryServices'

const ProcessDeliveryFormReport = ({
  heading,
  onClick,
}) => {
  ...
  const { data: allData, isLoading, isFetching } = useGetProcessDeliveryQuery({ params: { branchId, finYearId, ...searchFields, pagination: true, dataPerPage, pageNumber: currentPageNumber } });
...
export default ProcessDeliveryFormReport