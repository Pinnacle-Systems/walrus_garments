...
import { useGetDispatchedQuery } from '../../../redux/uniformService/DispatchedServices';
...
const ProductionDeliveryFormReport = ({
  ...
  const { data: allData, isLoading, isFetching } = useGetDispatchedQuery({
    params: {
      branchId
    }
  });
        ...
        >
          <table className="table-fixed text-center w-full">
            ...
            {isLoadingIndicator ?
              ...
              :
              <tbody className="border-2">{console.log(allData?.data, "alldatapd")}
