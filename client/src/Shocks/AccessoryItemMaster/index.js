...
import { DropdownInput, ReusableTable, TextInput, TextInputNew, ToggleButton } from '../../Inputs';
...
import { useAddAccessoryCategoryMasterMutation, useDeleteAccessoryCategoryMasterMutation, useGetAccessoryCategoryMasterByIdQuery, useGetAccessoryCategoryMasterQuery, useUpdateAccessoryCategoryMasterMutation } from '../../redux/uniformService/AccessoryCategoryMasterServices';
...
export default function Form() {
    ...
    const { data: allData, isLoading, isFetching, refetch } = useGetAccessoryCategoryMasterQuery({ params, searchParams: searchValue });
    const {
        data: singleData,
        isFetching: isSingleFetching,
        isLoading: isSingleLoading,
    } = useGetAccessoryCategoryMasterByIdQuery(id, { skip: !id });


    const [addData] = useAddAccessoryCategoryMasterMutation();
    const [updateData] = useUpdateAccessoryCategoryMasterMutation();
    const [removeData] = useDeleteAccessoryCategoryMasterMutation();
    ...
    return (
        ...
        <div onKeyDown={handleKeyDown} className="p-1">
            <div className="w-full flex bg-white p-1 justify-between  items-center">
                <h5 className="text-2xl font-bold text-gray-800">Accessory Category Master</h5>
