...
export default function Form() {
    ...
    const { data: allData, isLoading, isFetching } = useGetCountsMasterQuery({ params, searchParams: searchValue });
    ...
    return (
        <div onKeyDown={handleKeyDown}>
            <div className='w-full flex justify-between mb-2 items-center px-0.5'>
                <h5 className='my-1'>Counts Master</h5>
                ...
                >
                  ...
                  {form && (
                            <Modal
                                isOpen={form}
                                form={form}
                                widthClass={"w-[40%] max-w-6xl h-[40vh]"}
                                onClose={() => {
                                setForm(false);
                                setErrors({});
                                }}
                            >
                                ...
                                <div className="border-b py-2 px-4 mx-3 flex justify-between items-center sticky top-0 z-10 bg-white">
                                    ...
                                    <h2 className="text-lg px-2 py-0.5 font-semibold text-gray-800">
                                        {id ? (!readOnly ? "Edit Counts" : "Counts Master ") : "Add New Counts"}
                                    </h2>
