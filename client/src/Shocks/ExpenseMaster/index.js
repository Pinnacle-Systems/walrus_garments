...
import { useAddExpenseMasterMutation, useDeleteExpenseMasterMutation, useGetExpenseMasterByIdQuery, useGetExpenseMasterQuery, useUpdateExpenseMasterMutation } from "../../redux/uniformService/ExpenseMasterServices";
...
export default function Form() {
  ...
  const {
    ...
    isFetching,
    isLoading,
  } = useGetExpenseMasterQuery({ params });
  const {
    data: singleData,
    isFetching: isSingleFetching,
    isLoading: isSingleLoading,
  } = useGetExpenseMasterByIdQuery(id, { skip: !id });
  const [addData] = useAddExpenseMasterMutation()
  const [updateData] = useUpdateExpenseMasterMutation()
  const [removeData] = useDeleteExpenseMasterMutation()
  ...
  return (
    ...
    <div onKeyDown={handleKeyDown} className="p-1 h-[82vh]">
      <div className="w-full flex bg-white p-1 justify-between  items-center">
        <h5 className="text-lg font-bold text-gray-800">Expense Type Master</h5>
