...
export default function Form() {
    ...
    const { data: allData, isLoading, isFetching } = useGetItemCategoryQuery({ params, searchParams: searchValue });
    ...
    const saveData = (nextProcess) => {
        ...
        if (foundItem) {
            Swal.fire({
                text: "The Item Category is already exists.",
                icon: "warning",
            });
            return false;
        }
                                            ...
                                            <div className="space-y-4 ">
                                                <div className="grid grid-cols-2  gap-3  h-full">
                                                    <fieldset className=' rounded mt-2'>
                                                        <div className='mb-3'>
                                                            <TextInputNew1 name="Item Category Name" type="text" value={name} setValue={handleNameChange} required={true} readOnly={readOnly} disabled={(childRecord.current > 0)}
                                                                ref={firstInputFocus}
                                                            />
                                                        </div>
