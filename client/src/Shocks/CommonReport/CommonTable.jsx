...
//             <th
//               key={index}
//               className={`px-4 py-2 text-left font-medium text-[13px] whitespace-nowrap ${
//                 index < columns?.length - 1 ? 'border-r border-white/50' : ''
//               }`}
//             >
//               {column.header}
//             </th>
//           ))}
//           {rowActions && (
//             <th className="px-4 py-2 text-center font-medium text-[13px] whitespace-nowrap">
//               Actions
//             </th>
//           )}
//         </tr>
...
//             <tr
//               key={item.id}
//               className={`border-b border-gray-200 text-[12px] w-full ${
