# opening-stock-hydration Specification

## Purpose
Define Opening Stock as the legacy-only intake and hydration path for pre-existing stock while keeping canonical item creation and canonical inward flows separate.
