...
- [ ] 4.1 Smoke test `Quotation -> Sale Order -> Sales Delivery` conversion and confirm delivery prefill uses sale order values and items.
- [ ] 4.2 Verify Sales Invoice still opens, saves, edits, and reports normally as a standalone module.
- [ ] 4.3 Verify newly created sales deliveries link back to the originating sale order and no longer require a sales invoice to exist first.
