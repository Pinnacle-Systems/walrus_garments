...
import { get as _get, getOne as _getOne, create as _create, update as _update, remove as _remove } from '../services/cuttingOrder.service.js';
...
async function getOne(req, res, next) {
    try {
        ...
        // console.log(res.statusCode);
        res.json(await _getOne(req.params.id, req.params.cuttingReceiptId ? JSON.parse(req.params.cuttingReceiptId) : undefined,
            req.params.cuttingExcessFabricReturnId ? JSON.parse(req.params.cuttingExcessFabricReturnId) : undefined));
        console.log(res.statusCode);
    } catch (err) {
        console.error(`Error`, err.message);
    }
