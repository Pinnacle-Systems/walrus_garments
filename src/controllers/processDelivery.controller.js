...
import {
    ...
    getProcessDeliveryProgramItems as _getProcessDeliveryProgramItems
} from '../services/processDelivery.service.js';
...
export async function getProcessDeliveryProgramItems(req, res, next) {
    try {
        res.json(await _getProcessDeliveryProgramItems(req));
        console.log(res.statusCode);
    } catch (err) {
        console.error(`Error `, err.message);
    }
...
async function getOne(req, res, next) {
    try {
        res.json(await _getOne(req.params.id, req.params.processInwardId, req.params.processDeliveryReturnId, req.query));
        console.log(res.statusCode);
    } catch (err) {
        console.error(`Error`, err.message);
    }
