...
const router = Router();
import { get, getOne, getSearch, create, update, remove, getDirectReturnItems, getPoItemsandDirectReturnItems, getDirectReturnItemById } from '../controllers/accessoryPoReturn.controller.js';
