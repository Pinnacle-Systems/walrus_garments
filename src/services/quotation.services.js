...
async function get(req) {
    const { companyId, active, serachDocNo, supplier, searchDate, pagination, currentPageNumber, dataPerPage, branchId } = req.query;
    ...
    return { statusCode: 0, data: result, totalCount };
}
